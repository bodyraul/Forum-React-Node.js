...
export default function CompetencePoker() {
    ...
    const refAllCompetenceBloc = useRef();
    ...
    useEffect(() => {
      if(visible1===true){
        ...
        refAllCompetenceBloc.current.classList.remove("allCompetences");
        refAllCompetenceBloc.current.classList.add("allCompetencesVisible");
        ...
        affichageStat(paraTestTrois,refTitreCalme,refCalmeVisible,refCalmeInvisible,250,750,1250,"dixPourCent",setstat2);
        affichageStat(paraTestCinq,refTitreConcentration,refConcentrationVisible,refConcentrationInvisible,500,1000,1500,"OnzePourCent",setstat3);
        affichageStat(paraTestSept,refTitreCompetition,refCompetitionVisible,refCompetitionInvisible,750,1250,1750,"OnzePourCent",setstat4);
        affichageStat(paraTestNeuf,refTitreMotivation,refMotivationVisible,refMotivationInvisible,1000,1500,2000,"OnzePourCent",setstat5);
        setTimeout(() => {
  ...
  return (
    <div ref={refAllCompetence} className='containerCompetencePoker'>
        <div className='englobeTitreCompetencePoker'>
        ...
        <div  className='englobeAllCompetence'>
            <div ref={refAllCompetenceBloc}  className='allCompetences'>
                <div className='partieBulleCompetence'>
                    <div className='enteteCompetence'>
                        <div className='premiereCompetence'>
                            <button id='bulleAdaptation' onClick={()=>cliqueEUnpremiereCompetence(paraTestUn,paraTestDeux,refTitreAdaptation,"Patience",settitreUn,refAdaptationVisible,refAdaptationInvisible,"quinzePourCent","MoinsquinzePourCent","DouzePourCent",setstat1)} ref={paraTestUn} >Adaptation</button>
                            <button id='bullePatience' onClick={()=>cliqueEDeuxpremiereCompetence(paraTestUn,paraTestDeux,refTitreAdaptation,"Adaptation",settitreUn,refAdaptationVisible,refAdaptationInvisible,"DouzePourCent","diminutionDouzePourCent","quinzePourCent",setstat1)}  ref={paraTestDeux} >Patience</button>
                        </div>
                    </div>
                    ...
                    <div className='finCompetence'>
                        <div className='cinquiemeCompetence'>
                            <button id='bulleMotivation' ref={paraTestNeuf} onClick={()=>cliqueEUnpremiereCompetence(paraTestNeuf,paraTestDix,refTitreMotivation,"Intelligence",settitreCinq,refMotivationVisible,refMotivationInvisible,"OnzePourCent","diminutionOnzePourCent","dixPourCent",setstat5)} >Motivation</button>
                            <button id='bulleIntelligence' ref={paraTestDix} onClick={()=>cliqueEDeuxpremiereCompetence(paraTestNeuf,paraTestDix,refTitreMotivation,"Motivation",settitreCinq,refMotivationVisible,refMotivationInvisible,"dixPourCent","MoinsdixPourCent","OnzePourCent",setstat5)}  >Intelligence</button>
                        </div>
                    </div>
                </div>
