...
export default function Inscription() {
  ...
  const btnCliqueDonnes =(e)=>{
    setbtnDonnes(!btnDonnes);
  }
  ...
  const validerForm = (e)=>{
    ...
    if(btnDonnes=== false){
      return seterrorMsg("Vous devez cocher avant de valider.");
    }
    if(nom.length===0){
    ...
    <div>
        <form className='formulaireInscription' onSubmit={validerForm}>
          ...
          <div className='saisiFormInscrition'>
              ...
              <div className='btnDonne'>
                <input onClick={btnCliqueDonnes} type="checkbox" />
              </div>
